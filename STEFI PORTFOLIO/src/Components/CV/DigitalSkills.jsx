...
export default function DigitalSkills({open}){
    ...
    return(
        ...
        <div className={styles.digitalContainer}>
            <div className={styles.container}>
                <div ref={ref}>
                    {isInView ? <motion.h1 initial={{scale:0,x:-500,opacity:0}} animate={{scale:1,x:0,opacity:1}} transition={{duration:1,type:"spring",ease:"easeIn"}}>Known Programming Languages</motion.h1>:"" }
                </div>
        <div ref={ref} className={styles.digitalContainer}>
            {isInView ? <motion.div initial={{scale:0,opacity:0}} animate={{scale:1,opacity:1}} transition={{duration:1,bounce:0.5,type:"spring"}} className={styles.languageicon}>
